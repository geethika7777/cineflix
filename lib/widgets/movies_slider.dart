...
// Class for a slider widget displaying movies
class MovieSlider extends StatelessWidget {
  const MovieSlider({
    Key? key,
    required this.movies,  // Required parameter for list of movies
  }) : super(key: key);

  final List<Movie> movies;  // List of movies to be displayed in the slider
